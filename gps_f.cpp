...
void configureUblox(byte *settingsArrayPointer) {
  ...
  while(gpsSetSuccess < 3)
  {
    ...
    if (gpsSetSuccess == 5) {
      ...
      delay(1500);
      byte lowerPortRate[] = {0xB5, 0x62, 0x06, 0x00, 0x14, 0x00, 0x01, 0x01, 0x00, 0x00, 0xD0, 0x08, 0x00, 0x00, 0x80, 0x25, 0x00, 0x00, 0x07, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0xA2, 0xB5};
...
float extractAltitude(String nmea) {
  ...
  return nmea.substring(altitudeStart, altitudeEnd).toFloat();
}